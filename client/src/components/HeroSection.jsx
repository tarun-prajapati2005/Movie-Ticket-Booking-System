...
const HeroSection = () => {
    ...
    return (
        <div className='flex flex-col items-start justify-center gap-4 py-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen' >
